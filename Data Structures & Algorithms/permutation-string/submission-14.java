...
public class Solution {
    ...
    private boolean isPermutation(Map<Character, Integer> hashS1, Map<Character, Integer> hashS2) {
        for(Map.Entry<Character, Integer> entry : hashS1.entrySet()) {
            ...
            if(entry.getValue() != hashS2.getOrDefault(characterS1, -1)) { // The correct way of two map comparision. Here entry.getValue() != hashS2.get(characterS1) check will fail when hashS2.get(characterS1) == null bcz entry.getValue() != null will be always true
                return false;
            }
        }
        return true;
