...
class Solution {
    public ListNode removeNthFromEnd(ListNode head, int n) {
         ...
         deleteNextNode(start);
         return head;
    }

    // deletes the next node of the given node. This fn is written to delete the immediate 
    // next node. So it wont be able to delete the head node. However it ll be able to delete 
    // the end node
